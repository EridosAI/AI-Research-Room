...
def main() -> int:
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            # 39.1 — seat dropdown populates from code_seats / registry (not empty placeholder only)
            ...
            # change selection if another option exists; otherwise re-select current (persists)
